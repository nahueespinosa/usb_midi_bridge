...
#define DEVCE_AUDIO_MIDI_RX_DATA_BUFFER_ADDRESS      0x5C0
#define DEVCE_AUDIO_MIDI_TX_DATA_BUFFER_ADDRESS      0x600
#define DEVCE_AUDIO_MIDI_EVENT_DATA_BUFFER_ADDRESS   0x640
